...
switch($action) {
	...
	$sql_1 = " SELECT DATE(`dateAuto`) AS dt, `cvs_ha`, `cvs_har_add` , `cvs_val1b`
	...
	$sql_1 = " SELECT DATE(`dateAuto`) AS dt, `cvs_hl`, `cvs_har_lev` ,`cvs_val3b`
	...
	$sql_1 = " SELECT DATE(`dateAuto`) AS dt, `cvs_hc`, `cvs_har_car` ,`cvs_val2b`
