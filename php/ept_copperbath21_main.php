...
switch($action) {
	...
	$sql_1 = " SELECT DATE(`dateAuto`) AS dt, `cvs_ha`, `cvs_har_add` ,`cvs_val1c`
	...
	$sql_1 = " SELECT DATE(`dateAuto`) AS dt, `cvs_hl`, `cvs_har_lev`,`cvs_val3c`
	...
	$sql_1 = " SELECT DATE(`dateAuto`) AS dt, `cvs_hc`, `cvs_har_car` ,`cvs_val2c`
