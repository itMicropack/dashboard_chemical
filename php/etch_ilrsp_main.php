...
switch($action) {
	...
	$sql_1 = " SELECT DATE(`dateAuto`) AS dt, `area_daily`, `area_cumulative`
			   ...
			   FROM `etch_innerlayerresiststrip`
	...
	case 'graph_5b':
		...
		$sql_1 = " SELECT DATE(`dateAuto`) AS dt, `chambers_2`
		
				   FROM `etch_innerlayerresiststrip`
			
				   WHERE MONTH(`dateAuto`) = '".$date1."' AND `chambers_2` IS NOT NULL AND YEAR(`dateAuto`) = '".$date2."'
