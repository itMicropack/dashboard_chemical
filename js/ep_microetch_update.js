function getGraph_1(month,year) {
	...
	$.ajax({
		url: "../php/ep_microetch_main_update.php",
		type: 'POST',
...
function getGraph_2(month,year) {
	...
	$.ajax({
		...
		grid: {
			y: {
				lines: [{value: 0, class: 'gridLimit', text: 'Min: 2g/l'},{value: 40.0, class: 'gridLimit', text: 'Max: 40.0g/l'}]
			}
		}
...
function getGraph_3(month,year) {
	...
	$.ajax({
		...
		axis: {
			...
			y: {
				label: {
					text: 'Sulphuric Acid Analysis in %',
					position: 'outer-middle'
				},
				tick: {
					//format: d3.format('$,')
		...
		regions: [
			{axis: 'y', start: 0.5,  end: 2.5, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 1.0, class: 'gridLimit',  text: 'LSL: 1.0%'}, 
				        {value: 3.0, class: 'gridLimit',  text: 'USL: 3.0%'}, 
				        {value: 2.0, class: 'gridLimit1', text: 'Optimum: 2.0%'},
				        {value: 1.5, class: 'gridLimit2', text: 'LCL: 1.5%'},
				        {value: 2.5, class: 'gridLimit3', text: 'UCL: 2.5%'}
