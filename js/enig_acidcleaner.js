function getGraph_1(month,year) {
	...
	$.ajax({
		url: "../php/enig_acidcleaner_main.php",
		type: 'POST',
		...
		regions: [
			{axis: 'y2', start: 0, end: 750, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 0, class: 'gridLimit', text: 'Min: 0', axis: 'y2', position: 'start'}, {value: 750, class: 'gridLimit', text: 'Max: 750', axis: 'y2', position: 'start'}]
			}
		}
	...
	$.ajax({
		...
		axis: {
			...
			y: {
				show: true,
				label: {
					text: 'Acid Cleaner FR Addition in ml',
					position: 'outer-middle'
				},
				//min: 0,
				//max: 60,
...
function getGraph_3(month,year) {
	...
	$.ajax({
		...
		regions: [
			{axis: 'y', start: 40, end: 45, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 40, class: 'gridLimit', text: 'Min: 40'}, {value: 45, class: 'gridLimit', text: 'Max: 45'}]
			}
		}
		});
		},
