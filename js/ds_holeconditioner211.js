function getGraph_1(month,year) {
	...
	$.ajax({
		url: "../php/ds_holeconditioner211_main.php",
		type: 'POST',
...
function getGraph_2(month,year) {
	...
	$.ajax({
        ...
        data: {
			...
			names: {
				data1: 'Hole prepeg concentration',
				data2: 'Addition'
			},
			labels: true,
			types: {
		...
		axis: {
			...
			y: {
				label: {
					text: 'Hole prepeg concentration (%)',
					position: 'outer-middle'
				},
				tick: {
					//format: d3.format('$,')
		...
		regions: [
			{axis: 'y', start: 30,  end: 34, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 30, class: 'gridLimit', text: 'LSL: 30%'}, 
				        {value: 31, class: 'gridLimit3', text: 'LCL: 31%'}, 
				        {value: 32, class: 'gridLimit1', text: 'Optimum: 32%'},
				        {value: 33,class:'gridLimit2', text: 'UCL: 33%'},
				        {value: 34, class: 'gridLimit', text: 'USL: 34%'}
						]
			}
		}
		});
...
function getGraph_3(month,year) {
	...
	$.ajax({
		...
		regions: [
			{axis: 'y', start: 85, end: 110, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 85, class: 'gridLimit', text: 'Min: 85%'}, {value: 110, class: 'gridLimit', text: 'Max: 110%'}]
			}
		}
...
function getGraph_4(month,year) {
	...
	$.ajax({
		...
		grid: {
			y: {
				lines: [{value: 60, class: 'gridLimit', text: 'Min: 60°C'}, {value: 80, class: 'gridLimit', text: 'Max: 80°C'}]
			}
		}
