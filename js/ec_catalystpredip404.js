function getGraph_1(month,year) {
	...
	$.ajax({
		url: "../php/ec_catalystpredip404_main.php",
		type: 'POST',
		...
		regions: [
			{axis: 'y2', start: 0, end: 500.0, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 0, class: 'gridLimit', text: 'Min: 0', axis: 'y2', position: 'start'},{value: 500.0, class: 'gridLimit', text: 'Max: 1000.0', axis: 'y2', position: 'start'}]
			}
		}
		});
		},
...
function getGraph_2(month,year) {
	...
	$.ajax({
		...
		regions: [
			{axis: 'y', start: 0, end: 1.0, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 0, class: 'gridLimit', text: 'Min: 0'}, {value: 1.0, class: 'gridLimit', text: 'Max: 1.0'}]
			}
		}/*
		grid: {
			x: {
