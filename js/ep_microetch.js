...
function getGraph_2(month,year) {
	...
	$.ajax({
		...
		regions: [
			{axis: 'y', start: 2, end: 40.0, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 0, class: 'gridLimit', text: 'Min: 2'},{value: 40.0, class: 'gridLimit', text: 'Max: 40.0'}]
			}
		}
