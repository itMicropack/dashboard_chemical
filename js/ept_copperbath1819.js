function getGraph_1(month,year) {
	...
	$.ajax({
		url: "../php/ept_copperbath1819_main.php",
		type: 'POST',
		...
		grid: {
			y: {
				lines: [
						...
						{value: 220, class: 'gridLimit', text: 'LSL: 220 g/L'}, 
				        {value: 230, class: 'gridLimit2', text: 'LCL: 230 g/L'},
				        {value: 240, class: 'gridLimit1', text: 'Optimum: 240 g/L'},
				        {value: 255, class: 'gridLimit3', text: 'UCL: 255 g/L'},
...
function getGraph_6(month,year) {
	...
	$.ajax({
		...
		cache: false,
		success: function(dataset1) {
			console.log("ept_copperbath1819_main",dataset1)
			data5 = dataset1.data1;
			length = data5.length;
			for (i = 0; i < length; i++) {
				if (data5[i] == 0) {
