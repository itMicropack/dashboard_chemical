function getGraph_1(month,year) {
	...
	$.ajax({
		...
		grid: {
			y: {
				lines: [{value: 0, class: 'gridLimit', text: 'Min: 0', axis: 'y2', position: 'start'},{value: 500, class: 'gridLimit', text: 'Max: 500', axis: 'y2', position: 'start'}]
			}
		}
		});
		},
...
function getGraph_2(month,year) {
	...
	$.ajax({
		...
		regions: [
			{axis: 'y', start: 5, end: 12, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 8, class: 'gridLimit', text: 'LSL: 8%'}, {value: 12, class: 'gridLimit', text: 'USL: 12%'}, {value: 10, class: 'gridLimit1', text: 'Optimum: 10%',color:'red'}, {value: 9, class: 'gridLimit2', text: 'LCL: 9%'}, {value: 11, class: 'gridLimit3', text: 'UCL: 11%'}]
			}
		}
		});
		},
