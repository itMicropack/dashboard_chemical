function getGraph_1(month,year) {
	...
	$.ajax({
		url: "../php/ep_copperbath1819_main.php",
		type: 'POST',
		...
		grid: {
			y: {
				lines: [{value: 50, class: 'gridLimit', text: 'LSL: 50 g/L'}, 
				        {value: 55, class: 'gridLimit3', text: 'LCL: 55 g/L'},
				        {value: 60, class: 'gridLimit1', text: 'Optimum: 60 g/L'},
				        {value: 65, class: 'gridLimit2', text: 'UCL: 65 g/L'},
		...
		grid: {
			y: {
				lines: [{value: 100, class: 'gridLimit', text: 'LSL: 100 g/L'}, 
				        {value: 200, class: 'gridLimit3', text: 'LCL: 200 g/L'},
				        {value: 225, class: 'gridLimit1', text: 'Optimum: 225 g/L'},
				        {value: 245, class: 'gridLimit2', text: 'UCL: 245 g/L'},
