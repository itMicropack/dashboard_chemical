function getGraph_1(month,year) {
	...
	$.ajax({
		url: "../php/ec_acidcleanerafr2_main.php",
		type: 'POST',
...
function getGraph_2(month,year) {
	...
	$.ajax({
		...
		grid: {
			y: {
				lines: [{value: 1.7, class: 'gridLimit', text: 'LSL: 1.7N'}, {value: 2.1, class: 'gridLimit', text: 'USL: 2.1N'}, {value: 1.9, class: 'gridLimit1', text: 'Optimum: 1.9N'},{value: 1.8, class: 'gridLimit2', text: 'LCL: 1.8N'},{value: 2.0, class: 'gridLimit3', text: 'UCL: 2.0N'}]
			}
		}
		});
		},
...
function getGraph_3(month,year) {
	...
	$.ajax({
		...
		regions: [
			{axis: 'y', start: 40, end: 49, class: 'regionY'}
		],
		grid: {
			y: {
				lines: [{value: 40, class: 'gridLimit',  text: 'LSL: 40°C'}, 
				        {value: 49, class: 'gridLimit',  text: 'USL: 49°C'}, 
				        {value: 45, class: 'gridLimit1', text: 'Optimum: 45°C'},
				        {value: 43, class: 'gridLimit2', text: 'LCL: 43°C'},
