...
function getGraph_3(month,year) {
	...
	$.ajax({
		...
		grid: {
			y: {
				lines: [{value: 0.5, class: 'gridLimit', text: 'Min: 0.5'}, 
						{value: 1.0, class: 'gridLimit', text: 'Optimum: 1.0'}, 
						{value: 1.5, class: 'gridLimit', text: 'Max: 1.5'}
					]
			}
		}
		});
